    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                <p>© Copyright <?php echo date('Y'); ?> <span id="year"></span> By EVOVEO Tech. All Rights Reserved<br />Maintained By <a href="https://github.com/swamilax/corporZ/" target="_blank" rel="noopener noreferrer"><span class="color">EVOVEO Tech Team</span></a></p>
            </div>
        </div>
    </div>
</div>
